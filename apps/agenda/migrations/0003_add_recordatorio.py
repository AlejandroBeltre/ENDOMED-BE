    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['cita', 'canal', 'anticipacion_horas'], name='recordatori_cita_id_5cc905_idx'), models.Index(fields=['estado'], name='recordatori_estado_89e682_idx')],
            },
        ),
    ]
